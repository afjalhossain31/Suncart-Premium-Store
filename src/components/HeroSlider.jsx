...
export default function HeroSlider() {
  ...
  return (
    <section className="bg-[#FFFBF0] w-full px-2 py-6 md:py-5">
      <div className="container mx-auto max-w-[1400px]">
        <Swiper
          ...
          className="w-full aspect-[16/8] md:aspect-[21/7] rounded-3xl overflow-hidden shadow-2xl bg-[#E8E4D8]"
        >
              ...
              <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                <div className="px-4 md:px-16 max-w-4xl text-white text-center">
                  <div className="animate__animated animate__fadeInUp">
                    <span className="inline-block px-6 py-2 bg-orange-500 text-sm md:text-base font-black uppercase tracking-[0.2em] rounded-full mb-6 shadow-[0_10px_20px_-5px_rgba(249,115,22,0.5)]">
                      {slide.highlight}
                    </span>
